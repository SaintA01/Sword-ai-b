...
module.exports = { 
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2348165339092",
    OWNER_NAME: process.env.OWNER_NAME || \"Owner\",
    AUTOTYPING: process.env.AUTOTYPING || false,
    ...
    OWNER_NAME: process.env.OWNER_NAME || "Mysterioh",
