...
sword({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx2 I Am;Sword Bot_`)
        var txt = text.split(";")
        await m.react("⏳")
...
sword({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx3 I Am;Sword Bot_`)
        var txt = text.split(";")
        await m.react("⏳")
...
sword({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx4 I Am;Sword Bot_`)
        var txt = text.split(";")
        await m.react("⏳")
...
sword({
        ...
        try {
        if (!text) return await m.send(`_*provide three texts*_\n_example: ${prefix}gfx6 I Am;Sword Bot;Dev_`)
        var txt = text.split(";")
        if (txt.length < 3) return await m.send(`_*provide all three texts separated by semicolons*_\n_example: ${prefix}gfx6 I Am;Sword Bot;Dev_`)
        await m.react("⏳")
...
sword({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx7 I Am;Sword Bot_`)
        var txt = text.split(";")
        await m.react("⏳")
...
sword({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx8 I Am;Sword Bot_`)
        var txt = text.split(";")
        await m.react("⏳")
...
sword({
        ...
        try {
        if (!text) return await m.send(`_*provide text*_\n_example: ${prefix}gfx10 Sword Bot_`)
        await m.react("⏳")
...
sword({
        ...
        try {
        if (!text) return await m.send(`_*provide text*_\n_example: ${prefix}gfx11 Sword Bot_`)
        await m.react("⏳")
...
sword({
        ...
        try {
        if (!text) return await m.send(`_*provide text*_\n_example: ${prefix}gfx12 Sword Bot_`)
        await m.react("⏳")
...
sword({
  ...
  try {
        const response = await m.axios(`https://sword-api.vercel.app/lumina/search?query=${text}`)
